...
class NogodBikroy extends StatefulWidget {
  const NogodBikroy({Key? key}) : super(key: key);

  @override
  State<NogodBikroy> createState() => _NogodBikroyState();
}

class _NogodBikroyState extends State<NogodBikroy> {
