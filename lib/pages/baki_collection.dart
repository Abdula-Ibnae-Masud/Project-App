...
class BakiCollection extends StatefulWidget {
  const BakiCollection({Key? key}) : super(key: key);

  @override
  State<BakiCollection> createState() => _BakiCollectionState();
}

class _BakiCollectionState extends State<BakiCollection> {
